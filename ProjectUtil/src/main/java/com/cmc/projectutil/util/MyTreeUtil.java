...
public class MyTreeUtil {
     ...
     */
    @SneakyThrows
    public static <T extends BaseEntityFour> List<T> listToTree(List<T> list, boolean childrenFlag) {
     ...
     */
    public static <T extends BaseEntityFour> List<T> getFullTreeByDeepNode(List<T> deepNodeList, List<T> allList) {
     ...
     */
    public static <T extends BaseEntityFour> List<T> getFullTreeList(List<T> deepNodeList, List<T> allList) {
    ...
    private static <T extends BaseEntityFour> void getFullTreeListHandle(Map<Long, T> allMap, List<T> resultList,
        Long parentId) {
        if (parentId == 0) {
            return;
        }
